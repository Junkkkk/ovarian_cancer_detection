...
class XML:
    ...
    def generate_xml_mask_adj(self):        
        ...
        #tissue_img = np.asarray(tissue_img) * 255
        #print(mask.shape, tissue_img.shape)
...
if __name__ == "__main__":
    root = "/home/Dataset/BRCA/ovary/raw_images"
    mask_path = "/home/Dataset/BRCA/ovary/mask_images"
...
#        if not os.path.isfile(tissue_path):
            # if os.path.isfile(wsi_path) and os.path.isfile(xml_path) and os.path.isdir(data_path):
#           if os.path.isfile(wsi_path) and os.path.isdir(data_path):
